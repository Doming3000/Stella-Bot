...
export async function run(client, interaction) {
  // Servidores permitidos durante la etapa de pruebas
  const allowedGuilds = ['787098787881287711'];
  ...
  if (allowedGuilds.includes(interaction.guildId)) {
    ...
    interaction.reply({ content: "<:Advertencia:1302055825053057084> Este comando aún se encuentra en desarollo y no es funcional.", flags: 64, allowedMentions: { repliedUser: false }});
  }
}